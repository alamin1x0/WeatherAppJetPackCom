package com.example.watherappjetpack
...
import com.example.watherappjetpack.model.FutureModel
import com.example.watherappjetpack.model.HourlyModel
import com.example.watherappjetpack.ui.theme.WatherAppJetpackTheme
                ...
                item {
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .background(
                                color = colorResource(id = R.color.purple), // Ensure the color exists
...
val dailyItems = listOf(
    ...
    FutureModel("Mon", "windy", "Windy", 23, 11),
    FutureModel("Tue", "cloudy_sunny", "Cloudy Sunny", 27, 16),
    FutureModel("Wen", "sunny", "Sunny", 24, 12),
    FutureModel("Thu", "rainy", "Rainy", 22, 10),
)
